                ...
                <div class="col-lg-4 mt-5">
                    <div class="card">
                        <div class="card-body pb-0">
                            <h4 class="header-title">Dashboar Aplikasi Absensi</h4>
                    ...
                    <div class="card">
                        <div class="card-body bg1">
                            ...
                            <div class="testimonial-carousel owl-carousel">
                                <div class="tst-item">
                                    <div class="tstu-img">
                                        <img src="{{ url('srtdash/assets/images/team/team-author1.jpg') }}" alt="">
                                    </div>
                                ...
                                <div class="tst-item">
                                    <div class="tstu-img">
                                        <img src="{{ url('srtdash/assets/images/team/team-author2.jpg') }}" alt="author image">
                                    </div>
                                    <div class="tstu-content">
                                        <h4 class="tstu-name">Abel Franecki</h4>
                                        <span class="profsn">Designer</span>
                                ...
                                <div class="tst-item">
                                    <div class="tstu-img">
                                        <img src="{{ url('srtdash/assets/images/team/team-author3.jpg') }}" alt="author image">
                                    </div>
                                    <div class="tstu-content">
                                        <h4 class="tstu-name">Abel Franecki</h4>
                                        <span class="profsn">Designer</span>
